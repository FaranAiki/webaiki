 ...
 * Fully Client-side to avoid dynamic functions (headers, cookies) during SSR,
 * which prevents React Error #419 in Next.js 15 Suspense boundaries.
 */
export default function Loading() {
  ...
  useEffect(() => {
    ...
    const loadingTexts: Record<string, string> = {
      ...
      ru: "Подготовка лучшего сайта-портフォリオ",
