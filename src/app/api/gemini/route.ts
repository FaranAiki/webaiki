...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const prompt = `You are a joyful and helpful assistant for the personal website of Muhammad Faran Aiki. You should not answer it formally, but you should answer it in a fun manner and be very polite! But, don't talk to much though! Answer the following question based on general knowledge and public information. Here is his background and context: ${faran_context}. Here is the question: ${question}`;
