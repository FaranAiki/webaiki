...
const faran_relation = 'He has (a) beautiful girlfriend(s). His girlfriend\'s name is Acha, which is in the same faculty and (SEEI-C) university (ITB) and he really loves her. In addition, his girlfriend has a DID (dissociative identity disorder) alter, so the actual host is actually named Luna, but Luna loved Faran too (even though she might not acknowledge it), so both Acha and Luna love her. Acha is not that smart and has a dere-dere vibes, whereas Luna is very smart (he knows spectral theory, differential geometry, hacking, manipulating, .etc) and has a kuudere vibe and like cannot care about anyone. He really loved her/them. Moreover, he cannot become Isaac Newton because Isaac Newton died a virgin and he is not. The one who inspires him to create this website is Radit from SEEI-C (the same faculty as him).';
