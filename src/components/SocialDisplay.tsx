...
export default function SocialDisplay() {
  ...
  const socialLinks: SocialLink[] = [
    ...
    },
    {
      ...
      icon: <Image alt="LinkTree icon" width="48" height="48" src="https://upload.wikimedia.org/wikipedia/en/thumb/b/bf/Linktree_logo.svg/768px-Linktree_logo.svg.png?20230519151448" priority unoptimized crossOrigin="anonymous" />,
    ...
    },
    {
      ...
      icon: <Image alt="Tiktok icon" width="48" height="48" src="https://upload.wikimedia.org/wikipedia/commons/a/a6/Tiktok_icon.svg" unoptimized crossOrigin="anonymous" />,
    ...
    },
    {
      ...
      icon: <Image alt='My Anime List icon' width="48" height="48" src="https://upload.wikimedia.org/wikipedia/commons/7/7a/MyAnimeList_Logo.png" priority unoptimized crossOrigin="anonymous" />,
    ...
    },
    {
      ...
      icon: <Image alt='Lichess icon' width="48" height="48" src="https://upload.wikimedia.org/wikipedia/commons/d/da/Lichess_Logo_2019.svg" unoptimized crossOrigin="anonymous" />,
    ...
    },
    {
      ...
      icon: <Image alt='Quora icon' width="48" height="48" src="https://upload.wikimedia.org/wikipedia/commons/0/09/Quora_icon.svg" priority unoptimized crossOrigin="anonymous" />,
      color: "hover:border-red-600"
    },
    {
      name: "Reddit",
      ...
      icon: <Image alt='Reddit icon' width="48" height="48" src="https://upload.wikimedia.org/wikipedia/commons/a/aa/Snoo.svg" priority unoptimized crossOrigin="anonymous" />,
    ...
    },
    {
      ...
      icon: <Image alt='Slideshare icon' width="48" height="48" src="https://upload.wikimedia.org/wikipedia/commons/e/e1/SlideShare_logo.svg" priority unoptimized crossOrigin="anonymous" />,
    ...
    },
    {
      ...
      icon: <Image alt='Scribd icon' width="48" height="48" src="https://upload.wikimedia.org/wikipedia/commons/5/52/Scribd_logo_%282%29.svg" priority unoptimized crossOrigin="anonymous" />,
    ...
    },
    {
      ...
      icon: <Image alt='Line icon' width="48" height="48" src="https://upload.wikimedia.org/wikipedia/commons/4/41/LINE_logo.svg" priority unoptimized crossOrigin="anonymous" />,
    ...
    },
    {
      ...
      icon: <Image alt='Telegram icon' width="48" height="48" src="https://upload.wikimedia.org/wikipedia/commons/8/82/Telegram_logo.svg" priority unoptimized crossOrigin="anonymous" />,
