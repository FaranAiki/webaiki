  ...
  return (
    <div className="relative flex flex-col md:flex-row items-center justify-between gap-6">
      <div className="relative flex-1 z-1 text-center lg:text-left xs:pt-12 md:pt-6 lg:pt-0">
        <h1 id="tutorial-hero-target" aria-label="Muhammad Faran Aiki (Faran) — Software Engineer & ITB Student" className="text-3xl md:text-4xl lg:text-5xl font-black tracking-tighter text-black dark:text-white">
