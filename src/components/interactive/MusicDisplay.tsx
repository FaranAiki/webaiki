      ...
      {isPresentationMode && (
        ...
        <FadeInSection slideIndex={1} totalSlides={totalSlides} className="w-full h-full flex-shrink-0">
          <div className="flex flex-col items-center justify-center w-full max-w-4xl mx-auto p-4 pt-20 pb-10">
            ...
            <div 
              className="w-full h-[400px] md:h-[500px] relative rounded-3xl overflow-hidden shadow-2xl border border-theme-border group cursor-pointer transition-all hover:ring-2 hover:ring-green-500/50"
              ...
              {!spotifyLoaded && (
                <div className="absolute inset-0 flex items-center justify-center bg-black/5 dark:bg-white/5 transition-colors group-hover:bg-black/10 dark:group-hover:bg-white/10">
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <span className="text-theme-muted text-lg font-medium">{dict.Hover_To_Load || 'Hover to open the list'}</span>
                  </div>
                </div>
              )}
              {spotifyLoaded && (
        ...
        <FadeInSection slideIndex={2} totalSlides={totalSlides} className="w-full h-full flex-shrink-0">
          <div className="flex flex-col items-center justify-center w-full max-w-4xl mx-auto p-4 pt-20 pb-10">
            ...
            <div 
              className="w-full h-[300px] md:h-[450px] relative rounded-3xl overflow-hidden shadow-2xl border border-theme-border group cursor-pointer transition-all hover:ring-2 hover:ring-orange-500/50"
