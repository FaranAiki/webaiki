...
export default function AboutMe({
  ...
  about_principle_1,
  about_principle_2,
  about_principle_3, // Destructure new prop
  about_vision_mission_title,
  about_vision_mission_1,
  about_vision_mission_2,
  about_vision_mission_3, // Destructure new prop
  faran_photo
}: AboutMeProps) {
