    ...
    <div className="flex flex-col md:flex-row pt-2 justify-center items-center gap-8 md:gap-8 max-w-4xl mx-auto animate-fade-in">    
        <div className="text-center md:text-justify">
          ...
          <HoverableWords className="mt-4 text-lg text-gray-250 max-w-lg">
            Muhammad Faran Aiki (April 8, 2007) is currently a university student in School of Electrical Engineering and Informatics - Computation (SEEI-C), Bandung Institute of Technology. He is an intern at Analitica as the Education Team starting at May 2025 and a Flutter software engineer front-end (Technology Team) programmer starting at October 2025. Moreover, he is a certified-proven human anomaly.
          </HoverableWords>
        </div>
