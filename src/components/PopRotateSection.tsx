...
export default function PopRotateSection({ children, delay = 0, className = "" }: PopRotateSectionProps) {
  ...
  return (
    <div
      ...
      className={`transition-[opacity,transform,filter] duration-700 ease-[cubic-bezier(0.34,1.56,0.64,1)] transform will-change-[opacity,transform,filter] ${className} ${
        isVisible
